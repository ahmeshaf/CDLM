...
def extract_mentions(ann_dir, source_dir, working_folder):
    ...
    # add the event arg relations
    relations.extend(get_all_topic_rows(ann_dir, 'evt_slots'))

    # add the entity-entity relations
    relations.extend(get_all_topic_rows(ann_dir, 'rel_slots'))
